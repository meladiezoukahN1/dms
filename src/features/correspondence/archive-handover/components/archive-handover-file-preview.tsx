...
import { getArchiveHandoverFilePreviewUrl } from "../api/archive-handover.api";

interface ArchiveHandoverFilePreviewProps {
  file: ArchiveHandoverFileDto;
  open: boolean;
  onOpenChange: (open: boolean) => void;
}

export function ArchiveHandoverFilePreview({
  file,
  open,
  onOpenChange,
}: ArchiveHandoverFilePreviewProps) {
  const previewUrl = getArchiveHandoverFilePreviewUrl(file.fileId);
